...
do_impute <- function(dat, Y, beta, lambda, sigma, mu, pi, pos_mean = NULL, pos_sd = NULL, celltype = NULL, mcmc = 10, burnin = 2, verbose = F, pg = 0.5,
    ...
    return(list(loglik = tot, impt = (record_impt/mcmc) * pos_sd + pos_mean, impt_var = record_impt2/mcmc - (record_impt/mcmc)^2, EF = record_EF/mcmc, varF = varF,
        consensus_cluster = consensus_cluster/mcmc))
}
