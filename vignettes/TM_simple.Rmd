...
differentiation towards definitive endoderm are used as the real data study. We randomly selected part of the original data, and put it in our R package under `data` directory.
